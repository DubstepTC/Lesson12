...
but1 = Button(width=2, height=1, bg = "#ff0000")
but2 = Button(width=2, height=1, bg = "#ff7d00")
but3 = Button(width=2, height=1, bg = "#ffff00")
but4 = Button(width=2, height=1, bg = "#00ff00")
but5 = Button(width=2, height=1, bg = "#007dff")
but6 = Button(width=2, height=1, bg = "#0000ff")
but7 = Button(width=2, height=1, bg = "#7d00ff")
...
but3.pack(side=LEFT, padx = 2)
but4.pack(side=LEFT, padx = 2)
but5.pack(side=LEFT, padx = 2)
but6.pack(side=LEFT, padx = 2)
but7.pack(side=LEFT, padx = 2)
